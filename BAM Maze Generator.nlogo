...
A demonstration of the BAM maze generating algorithm. This model will randomly generate a maze with 1 unique solution to get from one red patch to the other (without crossing the white walls).
...
Press "Kill" to remove all the remaining turtles.

You can use the sliders to change the vertical position of the red patches (Start and Finish)
